  ...
  let handleSubmit = async (e) => {
    ...
    try {
      ...
      if (albumThumbnail) {
        ...
        albumData.append("upload_preset", "Music Album"); //? provide your upload preset name here
        albumData.append("cloud_name", "dgtwe7jad");  //? provide your cloud name here instead of rohitadhav

        //! Upload album thumbnail to the cloudinary
        let response = await fetch(
          "https://api.cloudinary.com/v1_1/dgtwe7jad/upload", //? Replace your cloud name here instead of rohitadhav
          {
            method: "POST",
            body: albumData,
          }
      ...
      await Promise.all(
        songDetails.map(async (song, index) => {
          ...
          if (song.songThumbnail) {
            ...
            songFileData.append("upload_preset", "Music Album"); //? provide your upload preset name here
            songFileData.append("cloud_name", "dgtwe7jad"); //? provide your cloud name here instead of rohitadhav
      ...
      let albumCollection = collection(__DB, "Music Album"); //? Replace music_albums with your atcual album collection name here
      ...
      <main className="w-full bg-gray-700 rounded-b-md">
        <form onSubmit={handleSubmit} className="w-full py-2 px-4">
                ...
                <section className="flex justify-between">
                  ...
                  <aside className="flex px-8 mb-4">
                    {songDetails.length === index + 1 && (
                      <div
                        onClick={addSong}
                        className="bg-yellow-400 flex items-center gap-2 hover:bg-green-600 cursor-pointer py-2 px-4 rounded"
                      >
                  ...
                  <aside className="flex px-8 mb-4">
                    {songDetails.length !== 1 && (
                      <div
                        ...
                        className="bg-yellow-600 flex items-center gap-2 hover:bg-red-600 cursor-pointer py-2 px-4 rounded"
                      >
          ...
          <article className="my-5 w-full flex justify-center items-center">
            <button className="w-[95%] py-2 text-lg font-semibold bg-yellow-400 hover:bg-yellow-700 rounded-lg mt-2 cursor-pointer">
