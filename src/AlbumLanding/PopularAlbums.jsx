...
import { GlobalAudioPlayer } from "../context/AudioPlayerContent";
  ...
  useEffect(() => {
    let fetchAlbums = async () => {
      try {
        ...
        let albumCollectionRef = collection(__DB, "Music Album");
                ...
                return (
                  ...
                  >
                    <div className="w-[260px] h-[330px] bg-black/50 p-4 rounded-lg hover:bg-black hover:ring-1 hover:ring-[wheat]">
                      ...
                      />
                      <h1 className="py-2 px-20 bg-black mt-2 rounded text-center ">
                        {album?.albumTitle}
                      </h1>
                    </div>
                  </NavLink>
