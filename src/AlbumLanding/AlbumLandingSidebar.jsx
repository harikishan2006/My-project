    ...
    <aside className="basis-[15%] bg-gray-900 min-h-[calc(100vh-70px)]">
      <nav className="w-full px-5 py-3">
        <ul className="w-full flex flex-col">
            ...
            <li>
                <NavLink to={"/"} end className={({isActive}) => `${isActive ? "bg-yellow-400 hover:bg-yellow-700" : ""} py-2 px-6 hover:bg-yellow-700 cursor-pointer flex items-center gap-1 rounded`}>
                    <BiSolidAlbum/>
