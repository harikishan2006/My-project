        ...
        <li>
          <NavLink
            ...
            className={({ isActive }) =>
              ...
              } px-4 py-2 font-semibold hover:bg-yellow-700 rounded-lg cursor-pointer`
            }
          >
            Login
          </NavLink>
          ...
          <li>
            <NavLink
              ...
              className={({ isActive }) =>
                `${
                  isActive ? "bg-yellow-400" : ""
                } px-4 py-2 font-semibold hover:bg-yellow-700 rounded-lg cursor-pointer flex gap-2 items-center`
              }
            >
              Admin
            </NavLink>
