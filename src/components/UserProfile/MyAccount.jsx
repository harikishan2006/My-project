        ...
        <main className="w-[100%] flex flex-col">
          <div className="w-full flex justify-between items-center px-6">
            ...
            <span className="flex items-center gap-2">
              ...
              state={userData}
                className={
                  "py-2 px-4 bg-yellow-400 rounded-md hover:bg-green-600 flex items-center gap-2"
                }
              >
                <span>Edit</span>
                <FaEdit />
            ...
            <aside className="w-full">
              ...
              <div className="flex justify-center items-center">
                <NavLink
                  to={"/user/profile/add-profile"}
                  className={
                    "py-2 px-10 my-5 bg-yellow-400 rounded-lg text-lg font-semibold cursor-pointer"
                  }
                >
                  Add Profile
                </NavLink>
